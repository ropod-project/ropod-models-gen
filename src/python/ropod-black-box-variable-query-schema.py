...
#
#     result = ropod_black_box_variable_query_schema_from_dict(json.loads(json_string))
...
class GenericType(Enum):
    ...
    here.
    """
    VARIABLE_QUERY = u"VARIABLE-QUERY"
...
class Payload:
    ...
    def __init__(self, black_box_id, sender_id):
    ...
    def from_dict(obj):
        assert isinstance(obj, dict)
        black_box_id = obj.get(u"blackBoxId")
        sender_id = obj.get(u"senderId")
        return Payload(black_box_id, sender_id)

    def to_dict(self):
        result = {}
        result[u"blackBoxId"] = self.black_box_id
...
class RopodBlackBoxVariableQuerySchema:
    ...
    def from_dict(obj):
        ...
        return RopodBlackBoxVariableQuerySchema(header, payload)
...
def ropod_black_box_variable_query_schema_from_dict(s):
    return RopodBlackBoxVariableQuerySchema.from_dict(s)


def ropod_black_box_variable_query_schema_to_dict(x):
    return to_class(RopodBlackBoxVariableQuerySchema, x)
